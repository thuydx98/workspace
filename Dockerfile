...
COPY ["backend/JWS.Mail/JWS.Mail.csproj", "JWS.Mail/"]
COPY ["backend/JWS.Common/JWS.Common.csproj", "JWS.Common/"]
...
COPY ["backend/JWS.EntityFramework/JWS.EntityFramework.csproj", "JWS.EntityFramework/"]
COPY ["backend/JWS.Contracts/JWS.Contracts.csproj", "JWS.Contracts/"]
